...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:w-4/12",
      className
    )}
    {...props}
  />
  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border border-slate-200 p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full dark:border-slate-800 data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        error:
          "border-2 border-red-500 bg-inherit text-slate-50 dark:border-red-500 dark:bg-inherit dark:text-slate-50",
        success:
          "border-2 border-green-500 bg-inherit text-slate-50 dark:border-green-500 dark:bg-inherit dark:text-slate-50",
        info: "border-2 border-blue-500 bg-inherit text-slate-50 dark:border-blue-500 dark:bg-inherit dark:text-slate-50",
        warning:
          "border-2 border-yellow-500 bg-inherit text-slate-50 dark:border-yellow-500 dark:bg-inherit dark:text-slate-50",
      },
    },
    defaultVariants: {
      variant: "default",
