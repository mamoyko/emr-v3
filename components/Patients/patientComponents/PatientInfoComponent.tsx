...
const PatientInfoComponent = ({ patient }) => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center md:flex-row">
      ...
      <figure className="mx-2 flex size-full flex-col rounded-lg bg-gradient-to-r from-neutral-700 via-neutral-800 to-neutral-900 p-3 lg:flex lg:p-1">
        <div className="size-full space-y-1 border-b p-1 text-center lg:px-8 lg:py-1 lg:text-left">
          <DetailComponent
            item={{
              label: null,
              value: patient?.name,
